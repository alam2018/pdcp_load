...
extern pdcp_t pdcp_array[MAX_NO_CONN_TO_PDCP];
extern int db_index, buffer_index;

void set_pdcp_configuration ()
{
...
//		  derive_key_up_enc(alg_id, kasme, &pdcp_array[count].kUPenc);
...
//      memcpy(&pdcp_pdu_p->data[pdcp_header_len], sdu_buffer_pP, 500);
			...
			update_pdu_db (sequencing_time_downlink, db_index);
#endif
...
*/
			...
			update_enc_db (encrypt_time, db_index);
#endif
